#!/usr/bin/env python3
"""
Bob (Roo-Cline) Harness Step Executor — phase 내 step을 순차 실행하고 자가 교정한다.
...
class StepExecutor:
    ...
    def _invoke_bob(self, step: dict, preamble: str) -> dict:
        ...
        print(f"     3. Bob이 작업을 완료하면 Enter를 누르세요...")
        
        input()  # 사용자가 Bob 작업 완료 후 Enter를 누를 때까지 대기
        
        # Bob이 작업을 완료했다고 가정하고 결과 기록
        output = {
            "step": step_num, "name": step_name,
            "exitCode": 0,
            "stdout": "Bob completed the task",
            "stderr": "",
        }
    ...
    def _execute_single_step(self, step: dict, guardrails: str) -> bool:
        ...
        for attempt in range(1, self.MAX_RETRIES + 1):
            ...
            with progress_indicator(tag) as pi:
                self._invoke_bob(step, preamble)
